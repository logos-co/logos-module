#!/usr/bin/env bash
#
# Execute every logos-module doc-test end-to-end and regenerate its Markdown.
#
...
# published flake. Each spec's `github:logos-co/logos-module{release}` URL is pinned to
...
# to logos-co/logos-module. A local-only / uncommitted HEAD won't resolve; export
